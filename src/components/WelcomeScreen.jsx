...
export default function WelcomeScreen({ onEnter }) {
  ...
  const hablar = () => {
    ...
    utterance.onend = () => { setSpeaking(false); setAudioEnded(true); };
    utterance.onerror = () => { setSpeaking(false); setAudioEnded(true); };
  ...
  return (
    <div style={{
      ...
      {/* Botón mute */}
      <button onClick={toggleMute} title={muted ? 'Activar voz' : 'Silenciar'}
        style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={handleEnter} style={{
            ...
            animation: audioEnded ? 'pulseGlow 2.8s ease-in-out infinite' : 'none',
          }}>
